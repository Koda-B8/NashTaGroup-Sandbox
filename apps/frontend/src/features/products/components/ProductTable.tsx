				...
				>
					<thead className="border-b border-base-border bg-base">
						<tr>
							...
							<th
								scope="col"
								className="px-3 py-3 text-2xs font-semibold tracking-wide text-text uppercase"
							>
								Product
							</th>
							<th
							...
							<th
								scope="col"
								className="px-3 py-3 text-right text-2xs font-semibold tracking-wide text-text uppercase"
							>
								Price
							</th>
							<th
