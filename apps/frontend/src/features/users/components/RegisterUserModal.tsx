			...
			>
				<ModalBody>
					...
					<div className="flex flex-col gap-1">
						...
						/>
						{errors.fullname && (
							<span className="text-xs text-deep-danger">
								{errors.fullname}
							</span>
						)}
					</div>
					...
					<div className="flex flex-col gap-1">
						...
						{errors.password ? (
							...
							<span className="text-xs text-text">8-128 karakter</span>
						)}
					</div>
					<div className="flex flex-col gap-1">
						...
						/>
						{errors.role && (
							<span className="text-xs text-deep-danger">{errors.role}</span>
						)}
					</div>
					<label
					...
					>
						...
						<span className="text-xs text-text">— isActive</span>
					</label>
				</ModalBody>
				<ModalFooter>
					<Button
